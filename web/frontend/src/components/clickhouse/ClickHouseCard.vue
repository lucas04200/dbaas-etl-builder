<template>
  <div class="instance-card" :data-clickhouse-id="instance.id">
    <div class="instance-card-head">
      <div style="display:flex;align-items:center;gap:10px">
        <div class="instance-card-icon" style="background:#FEFCE8">
          <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
            <rect x="3" y="4" width="3" height="12" rx="1" fill="#FACC15"/>
            <rect x="8" y="2" width="3" height="14" rx="1" fill="#FACC15"/>
            <rect x="13" y="6" width="3" height="10" rx="1" fill="#FACC15"/>
          </svg>
        </div>
        <div>
    ...
    <div class="instance-card-actions">
      <code style="font-size:12px;color:#6B7280;background:#F3F4F6;padding:4px 8px;border-radius:6px;flex:1">
        http://{{ hostname }}:{{ instance.host_port }}
      </code>
