<template>
  <nav class="sidebar">
    ...
    <div class="sidebar-bottom">
      <router-link v-if="isAdmin" to="/monitoring" class="nav-item" :class="{ active: route.path === '/monitoring' }">
        <svg width="15" height="15" viewBox="0 0 15 15" fill="none">
          <path d="M1 7.5h3.5l2-4 3 8 2-4H14" stroke="currentColor" stroke-width="1.3" stroke-linecap="round" stroke-linejoin="round"/>
        </svg>
        Monitoring
      </router-link>
