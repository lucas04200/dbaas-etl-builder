<template>
  <div class="instance-card" :data-superset-id="instance.id">
    <div class="instance-card-head">
      <div style="display:flex;align-items:center;gap:10px">
        <div class="instance-card-icon" style="background:#EEF9FC">
          <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
            <path d="M3 14l4-5 3 3 3-4 4 6" stroke="#20A7C9" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round"/>
            <rect x="2" y="2" width="16" height="16" rx="2" stroke="#20A7C9" stroke-width="1.4"/>
          </svg>
        </div>
        <div>
